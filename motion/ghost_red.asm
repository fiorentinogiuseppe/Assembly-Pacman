...
.macro move_red_left (%red_ghost_position)
	...
	sw $s1, 16($sp)					# Fazer com que o registrador responsavel por apontar o fantasma vermelho aponte para o no da esquerda
	lw $s2, 20($s1)			#
...
.macro move_red_right (%red_ghost_position)
	...
	sw $s1, 16($sp)					# Fazer com que o registrador responsavel por apontar o fantasma vermelho aponte para o no da direita
	lw $s2, 20($s1)			#
...
.macro move_red_up (%red_ghost_position)
	...
	sw $s1, 16($sp)					# Fazer com que o registrador responsavel por apontar o fantasma vermelho aponte para o no de cima
	lw $s2, 20($s1)			#
...
.macro move_red_down (%red_ghost_position)
	...
	sw $s1, 16($sp)					# Fazer com que o registrador responsavel por apontar o fantasma vermelho aponte para o no de baixo
	lw $s2, 20($s1)			#
